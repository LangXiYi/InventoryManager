 ...
 */
UCLASS()
class BASEINVENTORYSYSTEM_API UInvSys_BaseContainerObject : public UInvSys_BaseInventoryObject
{
	GENERATED_BODY()
...
UCLASS()
class BASEINVENTORYSYSTEM_API UInvSys_PreEditBaseContainerObject : public UInvSys_PreEditInventoryObject
{
	GENERATED_BODY()
};